...
console.log("The spacecraft " + spaceShuttle.name + " will take " + spaceShuttle.getDaysToLocation(kilometersToMars) + " to get to Mars.");
console.log("The spacecraft " + spaceShuttle.name + " will take " + spaceShuttle.getDaysToLocation(kilometersToTheMoon) + " to get to the Moon.");
